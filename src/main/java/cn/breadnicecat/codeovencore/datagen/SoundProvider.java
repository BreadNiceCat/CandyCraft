...
public class SoundProvider extends SoundDefinitionsProvider {
	...
	public SoundProvider(DatagenHelper datagenHelper, DataGenerator generator, ExistingFileHelper helper) {
	...
	public void registerSounds() {
		datagenHelper.sounds.forEach((soundEvent, definition) -> add(soundEvent, definition));
	}
}
