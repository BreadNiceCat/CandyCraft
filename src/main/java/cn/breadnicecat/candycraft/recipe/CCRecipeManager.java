...
public class CCRecipeManager {
	...
	//
	public static final ResourceLocation licorice_furnace_recipe_id = CandyCraft.prefix("licorice_furnace");
	public static final UndimodifiableObject<CCRecipeType<Recipe<Container>>> licorice_furnace_recipe_type = registerType(licorice_furnace_recipe_id);
	public static final RegistryObject<CCRecipeSerializerBase<? extends Recipe<?>>> licorice_furnace_recipe_serializer = registerSerializer(licorice_furnace_recipe_id, LicoriceFurnaceRecipe.Serializer::new);
